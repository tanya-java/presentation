...
image::/assets/img/jakarta-ee/java-enterprise/jee-component-technologies.png[JavaEE Architecture]

=== Spring Architecture

image::/assets/img/jakarta-ee/java-enterprise/spring-component-technologies.png[Spring Framework Architecture]
...
image::/assets/img/jakarta-ee/java-enterprise/jcp-efcp.png[JCP -> EFCP]
...
image::/assets/img/jakarta-ee/java-enterprise/javaee-spec-support.png[JavaEE spec support]
