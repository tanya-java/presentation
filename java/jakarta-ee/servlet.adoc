...
image::/assets/img/jakarta-ee/servlet/servlet-application-architecture.jpg[Servlet Application Architecture]
...
image::/assets/img/jakarta-ee/servlet/servlet-hierarchy.jpg[Servlet Hierarchy]

== Создание сервлета

=== Servlet Lifecycle

image::/assets/img/jakarta-ee/servlet/servlet-lifecycle.jpg[Servlet Lifecycle]
...
image::/assets/img/jakarta-ee/servlet/web-dynamic-app.png[Web dynamic app]
