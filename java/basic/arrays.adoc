...
image:/assets/img/java/basic/arrays/arrays.png[Arrays]
...
image:/assets/img/java/basic/arrays/arrays-2d.jpg[Multidimensional Arrays]
...
image:/assets/img/java/basic/arrays/arrays-2d-variable-length.jpg[Multidimensional Arrays]
