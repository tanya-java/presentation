...
image::/assets/img/java/basic/multithreading/java-multithreading.png[Java multithreading]
...
image::/assets/img/java/basic/multithreading/thread-life-cycle.png[Thread life cycle]
...
image::/assets/img/java/basic/multithreading/semaphore.png[Semaphore]

=== `Semaphore`

image::/assets/img/java/basic/multithreading/java-monitor.gif[Java monitor]
...
image::/assets/img/java/basic/multithreading/deadlock.jpg[Deadlock]
