...
* link:./java/basic/class-object.html[Class `Objects`]
* link:./java/basic/generics.html[Generics]
* link:./java/basic/enum.html[Enum]
* link:./java/basic/collections.html[Java Collection Framework]
...
* link:./java/basic/functional-interfaces.html[Functional interfaces]
