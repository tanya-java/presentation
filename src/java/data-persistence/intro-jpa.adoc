...
image::/res/img/java/data-persistence/intro-jpa/problem.jpg[Problem without ORM]

=== Solution

image::/res/img/java/data-persistence/intro-jpa/solution.jpg[Solution with ORM]
...
image::/res/img/java/data-persistence/intro-jpa/hibernate-history.png[Hibernate History]

=== Hibernate

image::/res/img/java/data-persistence/intro-jpa/hibernate.svg[Hibernate]
...
image::/res/img/java/data-persistence/intro-jpa/lifecycle.jpg[JPA lifecycle]
