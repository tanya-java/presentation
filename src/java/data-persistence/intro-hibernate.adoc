...
image::/res/img/java/data-persistence/intro-hibernate/hibernate.svg[Hibernate]

=== Hibernate Architecture

image::/res/img/java/data-persistence/intro-hibernate/architecture.png[Hibernate Architecture]

== Внутренняя архитектура классов Hibernate

=== Внутренняя архитектура классов Hibernate (5.4.18)

image::/res/img/java/data-persistence/intro-hibernate/classes-hierarhy.svg[Classes Hierarhy]

=== `SessionFactory`

`SessionFactory` (`org.hibernate.SessionFactory`) - threadsafe, immutable кэш откомпилированных маппинг для одной DB. 

image::/res/img/java/data-persistence/intro-hibernate/session-factory.jpeg[Session Factory]
...
image::/res/img/java/data-persistence/intro-hibernate/session.png[Session]
...
image::/res/img/java/data-persistence/intro-hibernate/object-lifecycle.jpeg[Session Lifecycle]
...
image::/res/img/java/data-persistence/intro-hibernate/transaction.png[Transaction]
...
image::/res/img/java/data-persistence/intro-hibernate/transaction-factory.png[Transaction Factory]
...
image::/res/img/java/data-persistence/intro-hibernate/connection-provider.jpeg[Connection Provider]

== Object Lifecycle

=== Object Lifecycle

image::/res/img/java/data-persistence/intro-hibernate/object-lifecycle.png[Object Lifecycle]

=== Object Lifecycle

image::/res/img/java/data-persistence/intro-hibernate/object-lifecycle-visual.png[Object Lifecycle Visual]
