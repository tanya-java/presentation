...
image:/res/img/java/spring/spring-logo.svg[Spring]
...
image:/res/img/java/spring/spring-overview.png[Owerview]
...
image:/res/img/java/spring/objects-dependencies.png[Objects Dependencies]
...
image:/res/img/java/spring/definitions.png[Inversion of Control, Dependency Inversion Principle and Dependency Injection]
...
image:/res/img/java/spring/spring-container.png[Spring Container]
...
image:/res/img/java/spring/dependency-injection.gif[Dependency Injection]
...
image:/res/img/java/spring/ioc-container.png[IoC container]

=== Example

image:/res/img/java/spring/di-testing.png[DI testing]
