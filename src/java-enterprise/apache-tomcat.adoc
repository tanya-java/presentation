...
image::/res/img/java-enterprise/apache-tomcat/apache-software-foundation.png[Apache Software Foundation, 300]
image::/res/img/java-enterprise/apache-tomcat/tomcat.png[Apache Tomcat]
...
image::/res/img/java-enterprise/apache-tomcat/tomcat-architecture.png[Apache Tomcat Architecture]
...
image::/res/img/java-enterprise/apache-tomcat/web-static-app.png[Web static app]
