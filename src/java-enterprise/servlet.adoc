...
image::/res/img/java-enterprise/servlet/servlet-application-architecture.jpg[Servlet Application Architecture]
...
image::/res/img/java-enterprise/servlet/servlet-hierarchy.jpg[Servlet Hierarchy]

== Создание сервлета

=== Servlet Lifecycle

image::/res/img/java-enterprise/servlet/servlet-lifecycle.jpg[Servlet Lifecycle]
...
image::/res/img/java-enterprise/servlet/web-dynamic-app.png[Web dynamic app]
...
System.out.println(servletCont.getInitParameter("contextParam"));
----
