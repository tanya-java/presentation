...
image::/res/img/java-enterprise/apache-maven/pom.png[POM]
...
image::/res/img/java-enterprise/apache-maven/flow.jpg[Apache Maven Flow]
...
image::/res/img/java-enterprise/apache-maven/lifecycle.jpg[Apache Maven Lifecycle]

=== Full lifecycle

image::/res/img/java-enterprise/apache-maven/lifecycle-full.png[Apache Maven Full Lifecycle]
http://localhost:3000/res/img/java-enterprise/apache-maven/lifecycle-full.png[Apache Maven Full Lifecycle]
...
image::/res/img/java-enterprise/apache-maven/artifacts.png[Artifacts]
...
image::/res/img/java-enterprise/apache-maven/repositories.jpg[Repositories]
